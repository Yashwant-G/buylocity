    ...
    <>
      ...
      <div className={`app ${light ? "background-light" : "background-dark"} h-[110vh] w-full`}>
        ...
        <div className='ml-[15%] mt-12 space-y-2'>
            ...
            <p className='text-blue-800 hover:underline'><a href="tel:+919899655710">+91 9899655710</a></p>
            <p className='text-lg'>Nishant</p>
            <p className='text-blue-800 hover:underline'><a href="tel:+918368947987">+91 8368947987</a></p>
        </div>
        <div className='ml-[15%] mt-8 space-y-2'>
            <p className='font-bold text-xl'>Email</p>
            <p className='text-blue-800 hover:underline'><a href='mailto: customercare@buylocity.in'>customercare@buylocity.in</a></p>
        </div>
        <div className='ml-[15%] mt-8 space-y-2'>
