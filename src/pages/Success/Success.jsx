...
const Success = () => {
  ...
  return (
    <div className={`w-full min-h-screen ${bgGreen && "bg-green-300"} transition-all duration-1000`}>
      <Helmet>
      ...
      <div className="pt-28">
        ...
        <div className="absolute z-10 top-0 left-20 text-red-500">Note*: Not a real order, its in development phase</div>
		  ...
		  <div><button onClick={()=>navigate('/track/1234')} className="h-text py-2 px-4 rounded-xl text-white bg-[var(--secondary-color)]">Track Your Order</button></div>
        </div>
      </div>
    </div>
  );
